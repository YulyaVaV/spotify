  ...
  return (
    <div className="latestRelease">
      <div className="latestRelease__latest">
        <h5 className="latestRelease__latest--title">LATEST RELEASE</h5>
        <div className="latestRelease__track">
          ...
          <div className="latestRelease__track--song">
            <p className="latestRelease__track--name">Drifting (Track Commentary)</p>
            <p className="latestRelease__track--data">4 December 2015</p>
          </div>
        </div>
      </div>   
    </div>
